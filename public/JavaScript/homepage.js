...
function displayD3(x){
  ...
  switch(x){
    case 0:
      returnDates = week();
      // var temp2 = getData(returnDates[0],returnDates[1]);
      // var tempData = [
      //   {label:"Entertainment",value:3},
      //   {label:"Education",value:4},
      //   {label:"Personal",value:5},
      //   {label:"Groceries",value:6},
      //   {label:"Restaurants",value:7},
      //   {label:"Utilities",value:8},
      //   {label:"Auto",value:9},
      //   {label:"Gifts",value:10},
      //   {label:"Investment",value:13}
      // ];
    ...
    case 1:
      ...
      var tempData = [
        ...
        {label:"Personal",value:89},
        {label:"Groceries",value:0},
        {label:"Restaurants",value:89.56},
        {label:"Utilities",value:89},
        {label:"Auto",value:89},
        {label:"Gifts",value:89},
        {label:"Investment",value:89}
      ];
      console.log(tempData);
      // fancyPieChart(getData(returnDates[0],returnDates[1]));
      change(tempData);
...
function change(data) {
  ...
  console.log("Stringify Data[0]: ",JSON.stringify(data[0]));
  JSON.stringify(data)
